...
?>
        <section class="interviewMv">
            <div class="interviewMv__img">
                <img src="<?php echo HOME; ?>img/interview04_mv.png" alt="" class="pc">
                <img src="<?php echo HOME; ?>img/interview04_mv_sp.png" alt="" class="sp">
            </div>
            <h1 class="pc interviewMv__copy flex vert">
                ...
                <div class="interviewMv__copy--inner js-in anime text-line-in anime__wrapper">
                    <div class="js-in anime text-in wave3">再生可能エネルギーの可能性</div>
                </div>
            </h1>
            <h1 class="sp interviewMv__copy flex vert">
                <div class="interviewMv__copy--inner js-in anime text-line-in anime__wrapper">
                    <div class="js-in anime left-in wave3">エシカル消費を推進する</div>
                </div>
                <div class="interviewMv__copy--inner js-in anime text-line-in anime__wrapper">
                    <div class="js-in anime left-in wave3">再生可能エネルギーの可能性</div>
                </div>
            </h1>
...
?>
        <section class="interviewSec">
                    ...
                    <div class="interviewSec__text pc-1">
                        ...
                        <div class="sp interviewSec__img pc-2">
                            <span class="js-in anime slideImg">
                                <img src="<?php echo HOME; ?>img/interview04_sec_01.png" alt="">
                            </span>
                        </div>
                        <p class="interviewSec__desc">
                            私が所属するあかりの森でんき推進チームは、2022年に発足したばかりの新しいチームです。正確にいうと、このプロジェクトは以前より動いていましたが、元あった部の中からスタートしており、そこから独立した形で新チームが結成されました。<br>
                            私は主に、「あかりの森プロジェクト」のサービスを広く認知してもらえるような販促企画を練ったり、購入された個人や企業へのサポートなどを行なったりしています。「あかりの森プロジェクト」の特徴は、再生可能エネルギーを利用した環境にやさしい電気です。再生可能エネルギーを用いてCO2の削減に努め、エコ活動への取り組みをサポートする内容になっています。<br>
                            料金プランは環境保全活動や豊かな自然を守ることの大切さを伝える「シナネンあかりの森プロジェクト」の活動の一部に充てられる仕組みになっています。お客様は「あかりの森でんき」を選ぶことによって、暮らしに欠かせないエネルギーの恩恵にあずかりながら、エコ活動へのアクションも起こせることに繋がります。環境保全活動と密接に関わる事業のため高い社会貢献度を感じ、使命感に似た思いを持って働いています。
                        </p>
                    </div>
                ...
                <div class="interviewSec__wrapper pc-flex bet">
                    <div class="interviewSec__text pc-2">
                        ...
                        <div class="sp interviewSec__img pc-1">
                            <span class="js-in anime slideImg">
                                <img src="<?php echo HOME; ?>img/interview04_sec_02.png" alt="">
                            </span>
                        </div>
                        <p class="interviewSec__desc">
            ...
            <div class="interviewSec__img js-in anime right-in">
                <span class="js-in anime slideImg">
                    <img src="<?php echo HOME; ?>img/interview04_sec_03.png" alt="">
                </span>
            </div>
            <div class="wrap w1200 sp-wrap">
                <div class="interviewSec__text">
                    ...
                    <p class="interviewSec__desc">
                        入社後1年目はシナネンの管理部・財務経理チームで会社全体の流れを把握でき、2年目に石油事業部の管理業務に就きました。さまざまな商材を扱うため、異動の度に新しい知識を習得することは容易ではありません。しかし、どの事業も人々の生活に必要なインフラを支えるやりがいを感じられ、異なる事業も毎回新鮮で楽しみながら取り組めています。<br>
                        もともと色々なことに興味を持ちやすく、好奇心旺盛な気質でしたが、この飽くなき探究心が仕事の原動力になっています。「あかりの森プロジェクト」も立ち上がったばかりのスタートで苦悩は絶えませんが、私に、未開の地を切り拓いていくパイオニア精神があったことにも気づかせてくれた当社に感謝しています（笑）。
                    </p>
                </div>
            </div>
            ...
            <div class="wrap w1200 sp-wrap">
                <div class="interviewSec__text">
                    ...
                    <p class="interviewSec__desc">
                        現在は5名のチームで働いています。上長は以前から現事業に携わっており、メンバーを牽引して事業を推進していて、そのパワーに憧れています。また、近年は専門スキルを持ったキャリア人材もグループ全体として増えており、私たちのチームにもSNS活用やWEBアナリストの見識を持つメンバーが加わりました。これまで専門職人材との関わりが少なかった私にとって、一つのことへの高い知見を武器に新たな切り口から事業アイデアを生み出す人の存在はとても良い刺激になっています。今まで気づかなかった視点を得られることにも面白みを感じますが、良い意味でシナネンに染まらない雰囲気や仕事のやり方なども新鮮で勉強になることばかりです。<br>
                        私たちのチームは、それぞれの役割があり、一人ひとりが専門性を持って業務にあたることで最大限の力が発揮されると感じています。私はこれまでの動向や現状、課題をチームメンバーと共有し、事業の拡大がより期待できるような働きかけを心がけていきたいです。具体的には、「あかりの森プロジェクト」のブランド力を高め、設定するターゲット層への高いリーチを実現していくことが目標。ちょっぴり難しい言葉を使いましたが、大切なのは「あかりの森プロジェクト」が多くの方から選ばれ、愛される商品となること。決して簡単なことではありませんが、このような意義ある新事業に携わるとは数年前の入社当初は思ってもいませんでした。<br>
        ...
        <section class="interviewMessage pc-flex">
            ...
            <div class="interviewMessage__text pc-flex vert hcenter">
                ...
                <p class="interviewMessage__desc">
                    「アルティメット」をやっていた人はいませんか？（笑）日本ではまだマイナーな競技ですが、私は学生時代にアルティメット部に所属していました。ひと目見たときから心がくすぐられすっかりのめり込んでいたんです。当社はそんな好奇心があれば活躍のフィールドを広げられます。何事にも前向きに取り組み、人との関わりを大事にすることができれば、どんどん挑戦できる場所です。世間から見ると「大きな会社」に見えるかもしれませんが、本当に一人ひとりが自分らしい理想のキャリアを叶えて輝くことができると思います。
                </p>
            </div>
        </section>
