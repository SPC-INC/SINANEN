        ...
        <section class="interviewSec">
            ...
            <div class="wrap w1200 sp-wrap">
                <div class="interviewSec__wrapper pc-flex bet">
                    <div class="interviewSec__text pc-1">
                        ...
                        <p class="interviewSec__desc">
                            学生時代はインドネシアへの留学を経験し、国際協力関連のボランティア活動にも参加しました。当社に入社を決めたのは、海外展開を行っているという点が大きなポイントでした。物心ついた頃から家族で海外旅行に行く機会があり、海外が遠い存在でなく、将来は日本だけに留まらず、広いフィールドで活躍できる人になりたいと思っていたのです。多様な人々が集まる中で言葉に頼らず、自分の意見を伝えることの大切さを学びました。ですから、海外事業を行うシナネンHDは魅力的でしたね。
                        </p>
                        <p class="interviewSec__desc">
                            ただそれだけでなく、当社を初めて企業説明会で見かけたとき、「あなたの力を貸してください！」というキャッチコピーが目に留まったのです。よくよく聞いてみると、今後の会社全体の大きな動きとして、さらなる躍進を求めて社内風土の見直しや組織変革を起こそうとしていると知りました。採用担当の方の眼差しは輝いており、心動かされた私はこの会社なら自分の力を最大限に発揮できるかもしれないと思えました。
                        </p>
                    </div>
                ...
                <div class="interviewSec__wrapper pc-flex bet">
                    <div class="interviewSec__text pc-2">
                        ...
                        <p class="interviewSec__desc">
                            現在は、施工管理チームの一員として案件の現場進行管理を担当しています。お客様や関連会社、職人さんなど多くの人との関わりがある中、スムーズに施工が行われるように人や資材、工程の管理を徹底しています。
                        </p>
                        <p class="interviewSec__desc">
                            また、当社はフランチャイズ展開をしており、インデスのノウハウを各フランチャイズ店に伝え、品質を担保することも役目です。そんな中、当社のサービス内容をマニュアル化し、すべての店舗で一定の水準を確保する取り組みが始まり、マニュアル作りを担当することになりました。会社としても初の試みとなり、責任感とやりがいはとても大きいです。
                        </p>
                        <p class="interviewSec__desc">
            ...
            <div class="wrap w1200 sp-wrap">
                <div class="interviewSec__text">
                    ...
                    <p class="interviewSec__desc">
                        「連携」といえば、私たちのチームが先日、優秀チーム賞に選ばれました。チームメンバーは現在5名。勤続歴10年以上のベテランが2名と4年目、3年目の中堅、そして私の構成です。表彰の評価基準はさまざまですが、前年度の功績を認められたチームだけが社長からもらえる特別な賞です。
                    </p>
                    <p class="interviewSec__desc">
                    ...
                    <p class="interviewSec__desc">
                        私は学生時代から海外を経験し、多様性を重要視していたため、何か一つのことに取り組んで成し遂げたときの達成感や一体感がたまらなく好きです。誰と働くか？ということも仕事をする上で大切なことだと感じており、だからこそ現チームでも感じられる団結力は仕事への原動力になっています。この事業を皆と一緒に盛り上げて、シナネンHDグループの大きな柱にしていきたいという想いも芽生えました。
                    </p>
                </div>
            </div>
            ...
            <div class="wrap w1200 sp-wrap">
                <div class="interviewSec__text">
                    ...
                    <p class="interviewSec__desc">
                        次の挑戦は、作り上げたマニュアルを多くの人に使ってもらい、当社のサービス力の向上を図るためにもどんどん使いやすさや分かりやすさを追求し、更新していきたいと考えています。作ったらそれで終わりではなく、ビジネスやサービスは、人や時代に合わせて都度最適化していくことが大切です。私はインデスの品質を創っていくことと守ること、そして広めていくことに貢献できればと思います。
                    </p>
                    <p class="interviewSec__desc">
                        そして、当社は変革のときを迎えています。私は今を過渡期と捉えており、どんな些細な意見やアイデアも多角的に見れば無限の可能性を秘めているため、尻込みせずにどんどん思ったことは言葉にしていこうと思っています。また、意見やアイデアに自分の情熱を乗せることも重要です。自分は何がしたくて何ができるか。常に自問自答しながら新たな分野に挑戦していきたいです。
                    </p>
                </div>
            </div>
        </section>
