                ...
                <div class="interviewSec__wrapper pc-flex bet">
                    <div class="interviewSec__text pc-1">
                        ...
                        <p class="interviewSec__desc">
                            現在は、ミライフ株式会社にて電力推進チームのセクションリーダーとして働いています。数名のメンバーのマネジメントを行いながら、主に製造工場やテナント、老人ホームや道の駅などの法人企業様を担当しています。そもそもシナネンホールディングスグループに入社を決めたのは、人の暮らしと密接に関わる仕事に就きたいと思ったからです。中でも、人を支える縁の下の力持ちのような立ち回りが私の特技であると感じており、陰ながら生活や社会を支えるインフラ業界に携わりたいと考えていました。他社も検討していましたが、最終的な決め手となったのは、各採用ステップの中で、担当者の方から面接に関するフィードバック（FB）をもらえたこと。一次面接後に合格の電話連絡があった際、私の面接時を振り返り、良かった点と改善点を丁寧に教えてくれたんです。他社も同じようなタイミングで採用スケジュールが進む中、30分ほどかけて丁寧にFBをくれたのはここだけでした。そんな姿勢に、「この会社は一人ひとりをちゃんと見てくれている」と感じられました。
                        </p>
                    </div>
