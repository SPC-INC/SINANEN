                ...
                <div class="businessChild__wrapper pc-flex bet">
                    ...
                    <div class="businessChildMain">
                        <div class="js-stickyNav-target">
                            <div class="businessChildMain__item" id="energy">
                            ...
                            <div class="businessChildMain__item" id="electric">
                                <h2 class="businessChildMain__head notos anime__wrapper">
                                    <div class="js-in anime text-in">
                                        電力事業
                                    </div>
                            ...
                            <div class="businessChildMain__item" id="oil">
                                <h2 class="businessChildMain__head notos anime__wrapper">
                                    <div class="js-in anime text-in">
                                        石油事業
                                    </div>
                            ...
                            <div class="businessChildMain__item" id="solution">
                                <h2 class="businessChildMain__head notos anime__wrapper">
                                    <div class="js-in anime text-in">
                                        ソリューション事業
                                    </div>
