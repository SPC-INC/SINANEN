...
##       #########    ##    ##       ##    ##  ##     ## ##   ##      ##
 ######  ##     ##    ##    ########  ######    #######  ##     ##    ##
*/
// チェックしたカテゴリーが一番上に並び替えられる挙動を抑止する
add_filter(
...
// {
//     $plugin_array['custom_button_script'] = T_URL . 'js/tinymce.min.js?v' . filemtime(T_PATH . 'js/tinymce.min.js');
//     return $plugin_array;
// }
...
##           ##      ##
 ###### ####### #######
*/
add_editor_style(T_HTTP . 'css/common.css'); //エディタのスタイル設定
